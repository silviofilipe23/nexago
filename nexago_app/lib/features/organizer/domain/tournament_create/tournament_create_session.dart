...
TournamentCreateDraft? _draftFromJson(
  ...
  try {
    ...
    return TournamentCreateDraft(
      ...
      requireFormedPair: json['requireFormedPair'] as bool? ?? false,
...
TournamentCategoryDraft? _categoryFromJson(
  ...
  try {
    ...
    return TournamentCategoryDraft(
      ...
      ageReference: _enumByName(
        TournamentAgeReference.values,
        json['ageReference'] as String?,
        TournamentAgeReference.tournamentStart,
      ),
      ageCustomEnabled: json['ageCustomEnabled'] as bool? ?? false,
      ageMinYears: json['ageMinYears'] as int?,
      ageMaxYears: json['ageMaxYears'] as int?,
