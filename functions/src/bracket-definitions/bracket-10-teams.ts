...
export const BRACKET_10_TEAMS: MatchDefinition[] = [
    ...
    // WB R4
    { matchNumber: 15, bracket: 'WB', round: 4, teamA: { type: 'WINNER', matchNumber: 11 }, teamB: { type: 'WINNER', matchNumber: 13 } },

    // LB R4
    { matchNumber: 16, bracket: 'LB', round: 4, teamA: { type: 'WINNER', matchNumber: 12 }, teamB: { type: 'WINNER', matchNumber: 14 } },
