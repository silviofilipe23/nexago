    ...
    <bo-auth-shell>
      <form [formGroup]="form" (ngSubmit)="submit()">
        ...
        <header class="bo-form-header">
          <span class="bo-kicker">Recuperar acesso</span>
          <h1>Esqueceu a senha?</h1>
          <p>Sem drama. Informa teu e-mail e a gente manda um link pra redefinir.</p>
        </header>
        ...
        <p class="bo-fine">O link expira em 1 hora e só funciona uma vez.</p>
      </form>
    </bo-auth-shell>
  `,
})
