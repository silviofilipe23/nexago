...
/** Barra de skeleton com shimmer — espelho do `OgcSkel` do design (Cascata · estados de
 *  loading). Compor várias num layout que imita a tela final; sempre `aria-hidden` (o
 *  container da tela anuncia o carregamento). Mesmo primitivo do portal do atleta. */
@Component({
