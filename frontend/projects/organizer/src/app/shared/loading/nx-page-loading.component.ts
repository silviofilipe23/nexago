...
/** Loading de página inteira (transição de nível da cascata / primeira carga) — espelho do
 *  `OgcLoadingPageScreen` do design: spinner 64px, título "Carregando X…" e subtítulo mono
 *  pulsante opcional. Anuncia via `role="status"`. */
@Component({
