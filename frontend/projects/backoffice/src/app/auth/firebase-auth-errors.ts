...
export function mapFirebaseAuthError(error: unknown): string {
  ...
  switch (code) {
    ...
    case 'auth/popup-blocked':
      return 'O navegador bloqueou o pop-up de login. Libere pop-ups e tente de novo.';
    ...
    case 'auth/invalid-verification-code':
      return 'Código inválido. Confere no app autenticador e tenta de novo.';
...
/** Cancelamentos de pop-up não devem virar erro na tela. */
