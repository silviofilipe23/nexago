...
export const BRACKET_26_TEAMS: MatchDefinition[] = [
    ...
    { matchNumber: 11, bracket: 'LB', round: 1, teamA: { type: 'LOSER', matchNumber: 7 }, teamB: { type: 'LOSER', matchNumber: 8 } },
    ...
    { matchNumber: 17, bracket: 'WB', round: 2, teamA: { type: 'WINNER', matchNumber: 9 }, teamB: { type: 'WINNER', matchNumber: 7 } },
