...
/**
 * Campo de texto do fluxo de auth (protótipo BoField). Integra com Reactive
 * Forms via ControlValueAccessor; senha ganha o toggle mostrar/ocultar,
 * campo travado (convite) ganha o cadeado.
 */
@Component({
  selector: 'bo-field',
...
export class FieldComponent implements ControlValueAccessor {
  ...
  /** Campo somente leitura com cadeado (e-mail do convite). */
  readonly locked = input(false);

  protected readonly fieldId = `bo-field-${nextFieldId++}`;
