...
export const BRACKET_25_TEAMS: MatchDefinition[] = [
    ...
    { matchNumber: 6, bracket: 'WB', round: 1, teamA: { type: 'SEED', seed: 13 }, teamB: { type: 'SEED', seed: 20 } },
    { matchNumber: 7, bracket: 'WB', round: 1, teamA: { type: 'SEED', seed: 12 }, teamB: { type: 'SEED', seed: 21 } },
    ...
    { matchNumber: 14, bracket: 'WB', round: 2, teamA: { type: 'SEED', seed: 4 }, teamB: { type: 'WINNER', matchNumber: 6 } },
    { matchNumber: 15, bracket: 'WB', round: 2, teamA: { type: 'SEED', seed: 5 }, teamB: { type: 'WINNER', matchNumber: 7 } },
    ...
    //LB R3
    { matchNumber: 31, bracket: 'LB', round: 3, teamA: { type: 'WINNER', matchNumber: 19 }, teamB: { type: 'WINNER', matchNumber: 26 } },
