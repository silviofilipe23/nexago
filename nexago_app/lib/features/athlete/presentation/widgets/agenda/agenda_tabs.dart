...
class AgendaTabs extends StatelessWidget {
  const AgendaTabs({
    super.key,
  ...
  final AthleteAgendaTimeTab selected;
  final int upcomingCount;
  final int pastCount;
  final ValueChanged<AthleteAgendaTimeTab> onChanged;
  ...
  Widget build(BuildContext context) {
    final isUpcoming = selected == AthleteAgendaTimeTab.upcoming;
                  ...
                  children: [
                    Expanded(
                      child: _TabSegment(
                        ...
                        count: upcomingCount,
                        selected: isUpcoming,
                        onTap: () => onChanged(AthleteAgendaTimeTab.upcoming),
                      ),
                    ),
                    Expanded(
                      child: _TabSegment(
                        ...
                        count: pastCount,
                        selected: !isUpcoming,
                        onTap: () => onChanged(AthleteAgendaTimeTab.past),
                      ),
                    ),
                  ],
                ),
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: SizedBox(
          height: AgendaTabs._segmentHeight,
          child: Row(
