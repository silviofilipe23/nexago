...
class _ArenaReviewsManagementPageState
  ...
  Widget build(BuildContext context) {
    ...
    // Defeito A (Task 12, ruling do controlador): `/arena/reviews` é área
    // `comunidade` de LEITURA — recepção e financeiro chegam aqui, mas só
    // `gestor` (e o dono) escrevem `comunidade`.
                ...
                data: (reviews) {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final canReply = arenaId.isNotEmpty &&
