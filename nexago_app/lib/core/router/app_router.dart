    ...
    routes: [
      ...
      GoRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: 'atletas-inscritos',
            name: AppRouteNames.tournamentEnrolledAthletes,
            builder: (context, state) {
              final id = state.pathParameters['tournamentId']?.trim() ?? '';
              return TournamentEnrolledAthletesPage(tournamentId: id);
            },
          ),
          GoRoute(
            path: 'palpites',
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          // etapa pedida já está liberada. `waiting` ainda caduca quando a
          // dupla fecha — ver `RegistrationStepInput.requestedStepWaitingOnly`.
          final stepRequest = registrationStepFromParam(
          ...
          return RegistrationGatePage(
            ...
            requestedStep: stepRequest?.step,
            requestedStepWaitingOnly: stepRequest?.waitingOnly ?? false,
          );
        },
      ),
      GoRoute(
      ...
      GoRoute(
        path: AppRoutes.tournamentRegistrationTerms,
